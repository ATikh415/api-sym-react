 ...
 * )
 * @UniqueEntity(fields="email", message="L'adresse doit etre unique")
 */
class User implements UserInterface
{
     ...
     *      min = 4,
     *      max = 255,
     *      minMessage = "Le mot de passe doit contenir plus de 3 caractere",
     *      maxMessage = "Le mot de passe doit contenir moin de 255 caractere"
     * )
     */
    private $password;
    ...
    /**
     * @ORM\OneToMany(targetEntity=Customer::class, mappedBy="users")
     */
    private $customers;
